    ...
    <div className="filter-container">
      <form className="filter" id="skater_form" onSubmit={handleSubmit}>
        <label>
          ...
          <FilterOption name="league" options={leagues} handleChange={handleChange} />
        </label>
        <label>
          <span className="label-container">Position:</span>
          <FilterOption name="position" options={positions} handleChange={handleChange} />
        </label>
        <label>
          <span className="label-container">Shoots:</span>
          <FilterOption name="shoots" options={shoots} handleChange={handleChange} />
        </label>
        <label>
          <span className="label-container">Round:</span>
          <FilterOption name="round" options={rounds} handleChange={handleChange} />
        </label>
        <label>
          <span className="label-container">Draft Year:</span>
          <FilterOption name="draft_year" options={draft_year} handleChange={handleChange} />
        </label>
      </form>
    </div>
  )
