        ...
        <tbody>
          {sortedProspects.map((p, i) => (
            <tr key={i}>
              ...
              <td className={sortColumn === "draft_year" ? "active-col" : ""}>
                {p.draft_year}
              </td>
              ...
              <td className={sortColumn === "games_played" ? "active-col" : ""}>
                {p.games_played}
              </td>
              ...
              <td className={sortColumn === "assists_pg" ? "active-col" : ""}>
                {p.assists_pg}
              </td>
              <td className={sortColumn === "points_pg" ? "active-col" : ""}>
                {p.points_pg}
              </td>
