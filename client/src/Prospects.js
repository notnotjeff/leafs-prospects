...
class Prospects extends Component {
  ...
  sortColumn(columnName) {
    ...
    // If Column Is Newly Selected Sort Direction Based On Column Type
      ...
      this.state.startAscendingColumns.includes(columnName)
        ? (sortDirection = "asc")
        : (sortDirection = "desc");
    }
  ...
  render() {
    ...
    return (
      <section>
        {data}
        <div className="updated-container">{updatedDiv}</div>
      </section>
    );
  }
}
