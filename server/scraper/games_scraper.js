  ...
  for (const prospect of prospects) {
    ...
    if (urlData.url !== undefined) {
      ...
      if (prospect.league === "OHL" || prospect.league === "WHL") {
        ...
        if (
          scrapedProspect.SiteKit.Player.games[gameIndex].date_played ===
          `${year}-${month}-${day}`
        ) {
          const goals = +scrapedProspect.SiteKit.Player.games[gameIndex].goals;
          const assists = +scrapedProspect.SiteKit.Player.games[gameIndex]
            .assists;
          const points = +scrapedProspect.SiteKit.Player.games[gameIndex]
            .points;
          const shots = +scrapedProspect.SiteKit.Player.games[gameIndex].shots;
          const penaltyMinutes = +scrapedProspect.SiteKit.Player.games[
            gameIndex
          ].penalty_minutes;
        ...
        if (
          scrapedProspect.SiteKit.Player.games[gameIndex - 1].date_played ===
          `${yYear}-${yMonth}-${yDay}`
        ) {
          const goals = +scrapedProspect.SiteKit.Player.games[gameIndex - 1]
            .goals;
          const assists = +scrapedProspect.SiteKit.Player.games[gameIndex - 1]
            .assists;
          const points = +scrapedProspect.SiteKit.Player.games[gameIndex - 1]
            .points;
          const shots = +scrapedProspect.SiteKit.Player.games[gameIndex - 1]
            .shots;
          const penaltyMinutes = +scrapedProspect.SiteKit.Player.games[
            gameIndex - 1
          ].penalty_minutes;
        ...
        const todaysGamesQMJHLMonth =
          parsedData.SiteKit.Gamebygame.games[
            dateHelpers.getMonthName(today.getMonth(), true)
          ] || [];
        const yesterdaysGamesQMJHLMonth =
          parsedData.SiteKit.Gamebygame.games[
            dateHelpers.getMonthName(yesterday.getMonth(), true)
          ] || [];
        const todaysGamesQMJHL = todaysGamesQMJHLMonth.filter(
          ({ date_played }) => date_played === `${year}-${month}-${day}`
        );
        const yesterdaysGamesQMJHL = yesterdaysGamesQMJHLMonth.filter(
          ({ date_played }) => date_played === `${yYear}-${yMonth}-${yDay}`
        );

        if (todaysGamesQMJHL.length > 0) {
          const goals =
            todaysGamesQMJHL[0].goals === "-" ? 0 : +todaysGamesQMJHL[0].goals;
          const assists =
            todaysGamesQMJHL[0].assists === "-"
              ? 0
              : +todaysGamesQMJHL[0].assists;
          const points =
            todaysGamesQMJHL[0].points === "-"
              ? 0
              : +todaysGamesQMJHL[0].points;
          const shots =
            todaysGamesQMJHL[0].shots === "-" ? 0 : +todaysGamesQMJHL[0].shots;
          const penaltyMinutes =
            todaysGamesQMJHL[0].penalty_minutes === "-"
              ? 0
              : +todaysGamesQMJHL[0].penalty_minutes;
        ...
        if (yesterdaysGamesQMJHL.length > 0) {
          const goals =
            yesterdaysGamesQMJHL[0].goals === "-"
              ? 0
              : +yesterdaysGamesQMJHL[0].goals;
          const assists =
            yesterdaysGamesQMJHL[0].assists === "-"
              ? 0
              : +yesterdaysGamesQMJHL[0].assists;
          const points =
            yesterdaysGamesQMJHL[0].points === "-"
              ? 0
              : +yesterdaysGamesQMJHL[0].points;
          const shots =
            yesterdaysGamesQMJHL[0].shots === "-"
              ? 0
              : +yesterdaysGamesQMJHL[0].shots;
          const penaltyMinutes =
            yesterdaysGamesQMJHL[0].penalty_minutes === "-"
              ? 0
              : +yesterdaysGamesQMJHL[0].penalty_minutes;
        ...
        if (
          games[gameIndex - 1].row.date_played === `${yYear}-${yMonth}-${yDay}`
        ) {
        ...
        const date = dateHelpers.getDateFromArray(
          scrapedProspect(
            "#pl_Games > tbody > tr:nth-last-child(1) > td:nth-child(4)"
          )
            .text()
            .split(" "),
          2,
        ...
        const secondLastDate = dateHelpers.getDateFromArray(
          scrapedProspect(
            "#pl_Games > tbody > tr:nth-last-child(2) > td:nth-child(4)"
          )
            .text()
            .split(" "),
          2,
        ...
        if (`${year}-${month}-${day}` === date) {
          const goals = +scrapedProspect(
            "#pl_Games > tbody > tr:nth-last-child(1) > td:nth-child(8)"
          ).text();
          const assists = +scrapedProspect(
            "#pl_Games > tbody > tr:nth-last-child(1) > td:nth-child(9)"
          ).text();
          const points = +scrapedProspect(
            "#pl_Games > tbody > tr:nth-last-child(1) > td:nth-child(10)"
          ).text();
          const shots = +scrapedProspect(
            "#pl_Games > tbody > tr:nth-last-child(1) > td:nth-child(21)"
          ).text();
          const penaltyMinutes = +scrapedProspect(
            "#pl_Games > tbody > tr:nth-last-child(1) > td:nth-child(14)"
          ).text();
        ...
        if (`${yYear}-${yMonth}-${yDay}` === secondLastDate) {
          const goals = +scrapedProspect(
            "#pl_Games > tbody > tr:nth-last-child(2) > td:nth-child(8)"
          ).text();
          const assists = +scrapedProspect(
            "#pl_Games > tbody > tr:nth-last-child(2) > td:nth-child(9)"
          ).text();
          const points = +scrapedProspect(
            "#pl_Games > tbody > tr:nth-last-child(2) > td:nth-child(10)"
          ).text();
          const shots = +scrapedProspect(
            "#pl_Games > tbody > tr:nth-last-child(2) > td:nth-child(21)"
          ).text();
          const penaltyMinutes = +scrapedProspect(
            "#pl_Games > tbody > tr:nth-last-child(2) > td:nth-child(14)"
          ).text();
        ...
        if (
          !scrapedProspect(
            "#stats-section > table > tbody > tr:nth-child(1) > td:nth-child(1)"
          )
            .text()
            .split(".").length === 3
        ) {
        ...
        const date = dateHelpers.getDateFromArray(
          scrapedProspect(
            "#stats-section > table > tbody > tr:nth-last-child(3) > td:nth-child(1)"
          )
            .text()
            .split("."),
          2,
        ...
        const row = scrapedProspect(
          "#stats-section > table > tbody > tr:nth-last-child(4) > td:nth-child(1)"
        )
          .text()
          .includes("yht.")
          ? 5
        ...
        const secondDate = dateHelpers.getDateFromArray(
          scrapedProspect(
            `#stats-section > table > tbody > tr:nth-last-child(${row}) > td:nth-child(1)`
          )
            .text()
            .split("."),
          2,
        ...
        if (`${year}-${month}-${day}` === date) {
          const goals = +scrapedProspect(
            "#stats-section > table > tbody > tr:nth-last-child(3) > td:nth-child(3)"
          ).text();
          const assists = +scrapedProspect(
            "#stats-section > table > tbody > tr:nth-last-child(3) > td:nth-child(4)"
          ).text();
          const points = +scrapedProspect(
            "#stats-section > table > tbody > tr:nth-last-child(3) > td:nth-child(5)"
          ).text();
          const shots = +scrapedProspect(
            "#stats-section > table > tbody > tr:nth-last-child(3) > td:nth-child(13)"
          ).text();
          const penaltyMinutes = +scrapedProspect(
            "#stats-section > table > tbody > tr:nth-last-child(3) > td:nth-child(6)"
          ).text();
        ...
        if (`${yYear}-${yMonth}-${yDay}` === secondDate) {
          const goals = +scrapedProspect(
            `#stats-section > table > tbody > tr:nth-last-child(${row}) > td:nth-child(3)`
          ).text();
          const assists = +scrapedProspect(
            `#stats-section > table > tbody > tr:nth-last-child(${row}) > td:nth-child(4)`
          ).text();
          const points = +scrapedProspect(
            `#stats-section > table > tbody > tr:nth-last-child(${row}) > td:nth-child(5)`
          ).text();
          const shots = +scrapedProspect(
            `#stats-section > table > tbody > tr:nth-last-child(${row}) > td:nth-child(13)`
          ).text();
          const penaltyMinutes = +scrapedProspect(
            `#stats-section > table > tbody > tr:nth-last-child(${row}) > td:nth-child(6)`
          ).text();
        ...
        const date = scrapedProspect(".rmss_t-stat-table__row")
          .first()
          .children("td:nth-child(1)")
          .text();
        const yesterdayDate = scrapedProspect(".rmss_t-stat-table__row")
          .first()
          .next()
          .children("td:nth-child(1)")
          .text();
        ...
        if (`${year}-${month}-${day}` === date) {
          const goals = +scrapedProspect(".rmss_t-stat-table__row")
            .first()
            .children("td:nth-child(5)")
            .text();
          const assists = +scrapedProspect(".rmss_t-stat-table__row")
            .first()
            .children("td:nth-child(6)")
            .text();
          const points = +scrapedProspect(".rmss_t-stat-table__row")
            .first()
            .children("td:nth-child(7)")
            .text();
          const penaltyMinutes = +scrapedProspect(".rmss_t-stat-table__row")
            .first()
            .children("td:nth-child(9)")
            .text();
          const shots = +scrapedProspect(".rmss_t-stat-table__row")
            .first()
            .children("td:nth-child(13)")
            .text();
        ...
        const date = dateHelpers.getDateFromArray(
          scrapedProspect(
            "#laConteiner > table > tbody > tr:nth-last-child(1) > td:nth-child(1)"
          )
            .text()
            .split("."),
          2,
        ...
        const secondLastDate = dateHelpers.getDateFromArray(
          scrapedProspect(
            "#laConteiner > table > tbody > tr:nth-last-child(2) > td:nth-child(1)"
          )
            .text()
            .split("."),
          2,
        ...
        if (`${year}-${month}-${day}` === date) {
          const goals = +scrapedProspect(
            "#laConteiner > table > tbody > tr:nth-last-child(1) > td:nth-child(6)"
          ).text();
          const assists = +scrapedProspect(
            "#laConteiner > table > tbody > tr:nth-last-child(1) > td:nth-child(7)"
          ).text();
          const points = +scrapedProspect(
            "#laConteiner > table > tbody > tr:nth-last-child(1) > td:nth-child(8)"
          ).text();
          const shots = +scrapedProspect(
            "#laConteiner > table > tbody > tr:nth-last-child(1) > td:nth-child(17)"
          ).text();
          const penaltyMinutes = +scrapedProspect(
            "#laConteiner > table > tbody > tr:nth-last-child(1) > td:nth-child(10)"
          ).text();
        ...
        if (`${yYear}-${yMonth}-${yDay}` === secondLastDate) {
          const goals = +scrapedProspect(
            "#laConteiner > table > tbody > tr:nth-last-child(2) > td:nth-child(6)"
          ).text();
          const assists = +scrapedProspect(
            "#laConteiner > table > tbody > tr:nth-last-child(2) > td:nth-child(7)"
          ).text();
          const points = +scrapedProspect(
            "#laConteiner > table > tbody > tr:nth-last-child(2) > td:nth-child(8)"
          ).text();
          const shots = +scrapedProspect(
            "#laConteiner > table > tbody > tr:nth-last-child(2) > td:nth-child(17)"
          ).text();
          const penaltyMinutes = +scrapedProspect(
            "#laConteiner > table > tbody > tr:nth-last-child(2) > td:nth-child(10)"
          ).text();
